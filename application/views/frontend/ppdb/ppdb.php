                        ...
                        <form action="<?= base_url('admin/daftar_absen') ?>" method="post">
                            <div class="modal-body">
                                <div class="overflow-auto" id="scrollTop" style="max-height: 700px;">
                                    ...
                                    <li><p style="padding-left: 10px;">6.3. Jika Anda masih memerlukan jawaban atas pertanyaan yang tidak terdapat dalam Syarat dan Ketentuan ini, Anda dapat menghubungi Kami di email ibrahimelgibran17@gmail.com atau menghubungi Kami di nomor <?= $web['telp'] ?></p></li>
